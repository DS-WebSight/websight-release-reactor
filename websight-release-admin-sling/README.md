...
Release WebSight Admin Sling module provides possibility to build ready-to-use Sling
package with all required WebSight modules.
...
Dynamic Solutions WebSight (Release WebSight Admin Sling) - Release WebSight Admin Sling
