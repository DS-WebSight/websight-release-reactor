...
Release Reactor is a module created for build release package from all required WebSight
Admin modules.
...
mvn clean package
```
## Maven dependencies schema
![Maven dependencies](./res/maven_dependencies.png)

## Copyrights

Dynamic Solutions WebSight (Release Reactor) - Release Reactor
