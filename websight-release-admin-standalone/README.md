...
Release WebSight Admin Standalone module provides possibility to build ready-to-use 
Stanalone WebSight Admin application with all required WebSight modules.
...
Dynamic Solutions WebSight (Release WebSight Admin Standalone) - Release WebSight Admin Standalone
